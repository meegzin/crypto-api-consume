...
function App() {
  ...
  useEffect(() => {
    ...
    .then(res => {
      setCoins(res.data)
    }).catch(error => alert('Existe um erro envolvendo a api'))
  }, [])
  ...
  return (
    <div className="coin-app">
      <div className="coin-search">
        <h1 className='coin-text'>Pesquise por uma cripto</h1>
        <form>
          <input type='text' placeholder='Pesquise aqui' className='coin-input' onChange={handleChange}>
          </input>
        </form>
      </div>
